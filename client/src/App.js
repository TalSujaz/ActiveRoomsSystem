  ...
  return (
    <Router>
      <div className="App">
        ...
        <Route path="/adminpanel" element={<div style={{color: 'white', padding: '2rem'}}>Floor View</div>}  />
        <Route path="/contact" element={<div style={{color: 'white', padding: '2rem'}}>Floor View</div>} />
